...
- Always use the template at `docs/sdd/templates/brainstorm.md`.
...
### 8. Save the Document
1. Read the template at `docs/sdd/templates/brainstorm.md`.
2. Create `docs/sdd/proposals/<feature-name>.brainstorm.md` with today's date.
3. Set `Status: exploration`.

### 9. Output
```
✅ Brainstorm saved: docs/sdd/proposals/<feature-name>.brainstorm.md
...
When `/sdd-spec` is invoked with a feature name that has a `.brainstorm.md` in `docs/sdd/proposals/`:
...
## Reference
- Brainstorm template: `docs/sdd/templates/brainstorm.md`
- Proposal template: `docs/sdd/templates/proposal.md`
- Spec template: `docs/sdd/templates/spec.md`
