...
1. Read the template at `docs/sdd/templates/proposal.md`.
2. Create `docs/sdd/proposals/<feature-title>.proposal.md` with today's date.
...
2. Link the proposal to the spec: add a `**Spec**: docs/sdd/specs/<name>.spec.md` line to the proposal.
...
### 6. Output
```
✅ Proposal saved: docs/sdd/proposals/<feature-title>.proposal.md
