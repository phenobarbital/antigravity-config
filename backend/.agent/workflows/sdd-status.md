...
Read `tasks/.index.json` and print a human-friendly status report of all SDD tasks.
...
Read `tasks/.index.json`. If a `<feature-name>` filter is provided, show only tasks for that feature.
