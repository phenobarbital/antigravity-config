...
<!-- Hard constraints that any solution must satisfy.
     e.g. performance targets, browser compatibility, accessibility, UX standards. -->
...
- `src/lib/components/...` — description of what to reuse
...
<!-- What does the end user see or experience? UI flows, interactions. -->
...
<!-- Which existing components/pages/routes are affected?
     Are there breaking changes? New dependencies? -->

| Affected Component | Impact Type | Notes |
|---|---|---|
| `component/page` | extends / modifies / depends on | ... |
